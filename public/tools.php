              ...
              <tr>
                <td style="vertical-align: top; width: 100%; padding-top: 15px;">
                  ...
                  <div id="cargando">
                    ...
                    <!-- Loading modal -->
                    <div class="modal modal-signup" id="loadingModal" tabindex="-1" role="dialog" aria-labelledby="signupModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    <h5 style="text-align: center; color: red;" class="modal-title text-center"><?PHP echo $txt["txt201"]; ?></h5>
                                    <p></p>
                                </div>
                                <div class="modal-body" style="background-color: #e9eaec; height: 450px; overflow-y: auto;">
                    ...
                    <!-- arrayUsersModal -->
                    <div class="modal modal-signup" id="arrayUsersModal" tabindex="-1" role="dialog" aria-labelledby="signupModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    <h5 style="text-align: center; color: red;" id="arrayUsersModalLabel" class="modal-title text-center"></h5>
                                    <p></p>
                                </div>
                                    ...
                                    <div style="padding-top: 10px; box-shadow: 0 2px 2px 0 rgba(0,0,0,.14),0 3px 1px -2px rgba(0,0,0,.2),0 1px 5px 0 rgba(0,0,0,.12); background-color: #FFFFFF;" class="row">
                                      <div class="col-xs-12">
                                        <div class="input-group">
                                          ...
                                          <input style="" class="form-control" type="text" id="palabraArrayUser" onkeyup="buscarArraUser();" placeholder="<?PHP echo $txt["txt301"]; ?>">
                                        </div>
                                      </div><!--col-xs-12-->
                                    </div><!--row-->  
