<?PHP
  ...
  if($status=="OK"){
	  ...
	  //DMS Mandados
	  if(!$max_id){
	    $dms = $twitteroauth->get("https://api.twitter.com/1.1/direct_messages.json?count=".$count."");
	  } else {
	    $dms = $twitteroauth->get("https://api.twitter.com/1.1/direct_messages.json?count=".$count."&max_id=".$max_id."");
	  }
