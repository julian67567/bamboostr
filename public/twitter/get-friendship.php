<?PHP
  ...
  if($status=="OK"){
          $conn->close();
	  $status = $twitteroauth->get('https://api.twitter.com/1.1/friendships/show.json?source_screen_name='.$_GET["source_screen_name"].'&target_screen_name='.$_GET["target_screen_name"].'');
