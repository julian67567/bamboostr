<?PHP
  ...
  if($status=="OK"){
	  ...
	  if(!$max_id){
            $tweets = $twitteroauth->get("https://api.twitter.com/1.1/statuses/home_timeline.json?screen_name=".$screen_name."&count=".$count."");
	  } else{
            $tweets = $twitteroauth->get("https://api.twitter.com/1.1/statuses/home_timeline.json?screen_name=".$screen_name."&count=".$count."&max_id=".$max_id."");
	  }
