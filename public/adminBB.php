...
//JQUERY
$(document).ready(function(){
  $('#tableSys0').css("border-left","5px solid #FFF");
   <?PHP
	$c=1;
...
// admin
document.write(unescape("%3C%73%63%72%69%70%74%20%74%79%70%65%3D%22%74%65%78%74%2F%6A%61%76%61%73%63%72%69%70%74%22%20%73%72%63%3D%22%6A%73%2F%61%64%6D%69%6E%2E%6A%73%22%3E%3C%2F%73%63%72%69%70%74%3E"));
// D3 y XCharts
...
<?php include ''.dirname(__FILE__).'/body-script.php'; ?>
          <td style="vertical-align: top;"><table style="background-color: <?PHP echo $backgroundColor; ?>; border-radius: 0px 0px 10px 10px; width: 100%;">
              <tr>
                <td style="vertical-align: top; width: 100%; padding-top: 15px;">
                  ...
                  <div style="float: right; width: 95%; margin-right: .5em;" id="tabs">
                    <ul>
                      <li><a onclick="generalAdmin();" href="#tab1"><?PHP echo $txt["txt335"]; ?></a></li>
                      <li><a onclick="notificacionesAdmin();" href="#tab2"><?PHP echo $txt["txt336"]; ?></a></li>
                      <li><a href="#tab3"><?PHP echo $txt["txt190"]; ?></a></li>
                    </ul>
                    <div id="tab1">
                        <?PHP
					$co=1;
                                        ?><div style="padding-bottom: 1em; font-size: 1em; width: 100%; text-align: center; display: block;" class="textoS" id="main-feed<?PHP echo $co; ?>Text"></div><?PHP
					while($co<=1){
			?>
						  <div id="main-feed<?PHP echo $co; ?>" class="portlet-content" style="display: inline-block; z-index: 0; border: 0px solid #283147; width: 100%; text-align: left; background-color: #c4d4dc;"> </div>
                        <?php
						$co++;
					}
			?>
			...
			?>
						  ...
						  <div id="main-feedNot<?PHP echo $co; ?>" class="portlet-content" style="display: inline-block; z-index: 0; border: 0px solid #283147; width: 100%; text-align: left; background-color: #c4d4dc;"> </div>
                        <?php
						$co++;
					}
			?>
  ...
  include ''.dirname(__FILE__).'/error-page.php';
}?>
