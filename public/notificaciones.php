...
<!-- Marca de agua -->
    <div style="height: 340px;" class="modal modal-signup" id="watermark" tabindex="-1" role="dialog" aria-labelledby="signupModalLabel" aria-hidden="true">
...
<!-- Signup Modal -->
    <div style="height: 340px;" class="modal modal-signup" id="signup-modal" tabindex="-1" role="dialog" aria-labelledby="signupModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div>
...
<!-- Notifications Modal -->
    <div style="height: 340px;" class="modal modal-signup" id="notificacionesAbrir" tabindex="-1" role="dialog" aria-labelledby="signupModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div>
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 style="text-align: center;" id="notificacionesLabel" class="modal-title text-center"></h4>
                    <!--<p class="intro text-center">It only takes 3 minutes!</p>-->
                    <p></p>
                </div>
                <div class="modal-body">
                    <div class="social-login text-center">    
                        <p id="notificacionesBody" style="padding-top: 20px; text-align: center;" class="note"></p>
                    </div>
